/*
The main function for the Al dynamic properties simulation
...
int main()
{
  ...
  int Nc = 4, N = 256 , n_timesteps = 20000;
  ...
  for (int i = 0; i < N; ++i)
    {
      for (int j = 0; j < 3; ++j)
	{
	  mag = a0*0.15; /* setting the magnitude of the maximum noise to 6.5% of the position value */
